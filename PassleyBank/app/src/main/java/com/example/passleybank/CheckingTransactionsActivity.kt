...
class CheckingTransactionsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        homeButton.setOnClickListener {
            ...
            val intent = Intent(this@CheckingTransactionsActivity, MainActivity::class.java)
            startActivity(intent)
        }

        accountsButton.setOnClickListener {
            // Perform an action when the Accounts button is clicked
            val intent = Intent(this@CheckingTransactionsActivity, AccountsActivity::class.java)
            startActivity(intent)
        }
    }
}
